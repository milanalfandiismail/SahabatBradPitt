...
class IsOwnerOrReadOnly(permissions.BasePermission):
    ...
    def has_object_permission(self, request, view, obj):
        if request.method in permissions.SAFE_METHODS:
            return True
        # Allow staff or superuser to delete object (for review moderation)
        if request.method == 'DELETE' and request.user and (request.user.is_staff or request.user.is_superuser):
            return True
